function [Population,Fitness,selected] = EnvironmentalSelection(Population,N,processcon,totalcon,r)
...
%--------------------------------------------------------------------------
    ...
    [fpr,fcd]  = Estimation(Population.objs,r);
    PopObj_1   = [fpr,fcd]; 
    if ~processcon
    ...
    elseif processcon > totalcon
        ...
        Fitness = CalFitness(PopObj_1,Population.cons,processcon);
    end
