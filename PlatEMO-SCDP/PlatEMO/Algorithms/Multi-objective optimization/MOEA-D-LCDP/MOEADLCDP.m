classdef MOEADLCDP < ALGORITHM
	...
	%in IEEE Transactions on Systems, Man, and Cybernetics: Systems, vol. 54, no. 3, pp. 1376-1387, March 2024, doi: 10.1109/TSMC.2023.3324797. 
    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if Problem.FE/Problem.N == gene(k) || Problem.FE > Problem.maxFE-2*Problem.N
                    pop_gen = gene(k); % 获取类名
                    pop = Population.objs;
                    fileName1 = sprintf('D:\\experiment\\PlatEMO-EPDCMO\\Gen\\MOEADLCDP_DAS3_%d.mat', pop_gen);
                    save(fileName1, 'pop', '-V7.3'); % 保存第一个文件
                    k = k+1;
                end
                if Problem.FE >= Problem.maxFE-Problem.N
                    fileName2 = sprintf('D:\\experiment\\PlatEMO-EPDCMO\\Cov\\MOEADLCDP_DAS3_cov.mat');
