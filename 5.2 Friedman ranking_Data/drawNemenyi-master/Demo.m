...
results =  xlsread('D:\experiment\0drawNemenyi-master\Data_handle\RW5.xlsx','Sheet1');
Names = {'NSGAII', 'CMOEA\_MS', 'CTAEA', 'CCMO', 'C3M', 'URCMO', 'MOEADLCDP', 'SCDP'}; % names
OutputFolder  = 'D:\experiment';     % Output folder
